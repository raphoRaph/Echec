//import {un_truc} from 'mon-module'
// Credits = https://codepen.io/Myscript2010/pen/MyGKKq
// AJOUTER //
/*
Create path and svg
...
- rock (petit et grand)
- prise en passant
- svg de son-on et son-off
- svg carnet
- svg des croix (moins d'images)
- svg des cases (moins d'images)
- json des svg
- svg des images d'explications
...
fond.volume = 0.5 // Volume par défault
fond.loop = true
var toggle = [[true, 0.5], [true, 0.5]]
var slider1 = document.getElementById("myRange1");
var output1 = document.getElementById("demo");
slider1.oninput = function() {
  fond.volume = Number(this.value)/100
  toggle[0][1] = Number(this.value)/100
}
var slider2 = document.getElementById("myRange2");
var output2 = document.getElementById("demo");
slider2.oninput = function() {
  SonMove.volume = Number(this.value)/100
  toggle[1][1] = Number(this.value)/100
}


function mute_toogle1(){
    if (toggle[0][0] == true){
        toggle[0][0] = false
        fond.volume = 0
        ...
        toggle[0][0] = true
        fond.volume = toggle[0][1]
        console.log(toggle[0][1])
        document.getElementById("myRange1").value = toggle[0][1]*100
    }
}
function mute_toogle2(){
    if (toggle[1][0] == true){
        toggle[1][0] = false
        SonMove.volume = 0
        ...
        toggle[1][0] = true
        SonMove.volume = toggle[1][1]
        console.log(toggle[1][1])
        document.getElementById("myRange2").value = toggle[1][1]*100
    }
}
...
// rends la case accessible par le pion selectionnÃ©
...
// deplace le pion et lance plusieurs fonctions Ã  chaques deplacements
...
// lance un son alÃ©atoire de deplacement ou de mort
...
// lance un son alÃ©atoire si le roi est mis en echec
function son_echec(){
