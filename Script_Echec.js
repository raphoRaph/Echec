...
for (let k = 3; k < 9; k++) {
    document.getElementById("g"+ String(k)).style.marginLeft = String(k*(1200/13) + 50) + "px"
    
}

var Taille=screen.width;
var img_gauche = document.getElementById("gauche")

for (let j = 1; j < 14; j++) {
    document.getElementById("p" + String(j)).style.visibility = "hidden"
    document.getElementById("r" + String(j)).src = "Image/point_.png"
}


var page = 1;
function tourne_gauche(event){
    if(page > 1){
        for (let i = 1; i < 14; i++) {
            document.getElementById("p"+ String(i)).style.visibility = "hidden";
            document.getElementById("r" + String(i)).src = "Image/point_.png"            
        }
        page -= 1
        document.getElementById("p"+ String(page)).style.visibility = "visible";
        document.getElementById("r" + String(page)).src = "Image/point.png"
        document.getElementById("milieu").style.filter = "hue-rotate(" + String((page - 1)*(360/13)) +"deg)"
    }
}
...
function a_page(h){
    ...
    document.getElementById("r"+ String(h)).src = "Image/point.png"
    document.getElementById("milieu").style.filter = "hue-rotate(" + String((h - 1)*(360/13)) +"deg)"
    page = h
}
...
function menu(){
    ...
    document.getElementById("r1").src = "Image/point.png"
    page = 1
}
